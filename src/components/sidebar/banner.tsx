...
export function SidebarBanner() {
  return (
    <div className="mt-4 p-3 relative overflow-hidden rounded-xl border border-emerald-500/20 backdrop-blur-sm bg-gradient-to-br from-emerald-500/5 to-transparent shadow-md shadow-emerald-500/10">
      <div
