...
export default function inviteSuccessPage() {
  ...
  `}
        ...
        <p className="text-lg lg:text-xl font-light text-neutral-600 dark:text-neutral-300 max-w-2xl">
          O bot foi adicionado com sucesso ao seu servidor! Recomendamos que
          leia a{" "}
          <a
            href="/docs"
            className="text-emerald-400 animate-pulse underline hover:opacity-80 transition-all"
          >
            documentação
          </a>{" "}
          antes de utilizar. Se tiver alguma dúvida,{" "}
          <a
            href="/support"
            className="text-emerald-400 animate-pulse underline hover:opacity-80 transition-all"
          >
