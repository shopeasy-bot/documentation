...
export const metadata: Metadata = {
  title: "Reclamações - ShopEasy",
  description: "Teve um problema com o ShopEasy? Conte pra gente e vamos resolver.",
  openGraph: {
    title: "Reclamações - ShopEasy",
    description: "Teve um problema com o ShopEasy? Conte pra gente e vamos resolver.",
    url: `${process.env.NEXT_PUBLIC_SITE_URL}/reclamacoes`,
  },
};
  ...
  return (
    <main className="flex flex-1 flex-col z-10 items-center justify-center text-center gap-10 px-4 py-20">
      ...
      <div className="flex flex-col items-center gap-3 max-w-xl motion-preset-expand motion-delay-[100ms]">
        <span className={`${jetbrains.className} text-xs uppercase tracking-widest text-red-500`}>
          Reclamações
        </span>
        ...
        <p className="text-sm text-neutral-500 dark:text-neutral-400">
          Conte com detalhes o que aconteceu. Levamos toda reclamação a sério e respondemos o
          mais rápido possível.
        </p>
      </div>

      <div className="motion-preset-expand motion-delay-[150ms] w-full flex justify-center">
        <FeedbackForm type="reclamacao" accent="red" />
      </div>
